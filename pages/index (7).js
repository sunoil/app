        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0 }}>
            <div style={{
              ...
              background: `linear-gradient(135deg,${C.primary},${C.primaryDark})`,
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: "0 2px 8px rgba(45,212,168,0.3)",
            }}>
              <span style={{ fontSize: 13, fontWeight: 700, color: "#fff" }}>2π</span>
            </div>
            <div style={{ minWidth: 0 }}>
              <p style={{ fontSize: 12, fontWeight: 700, margin: 0, color: C.text }}>Install TwoPiR</p>
              <p style={{ fontSize: 10, color: C.textSec, margin: "1px 0 0", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          ...
          <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
            <button onClick={() => setShowInstallBanner(false)} style={{
              ...
              color: C.textSec, cursor: "pointer", fontFamily: "'DM Sans',sans-serif",
            }}>Later</button>
